...
class WordProcess:
    ...
    def words_dict(self):
        ...
        if os.path.getsize(self.file) > 1e7:
            ...
            wordlist_path = os.path.expanduser(
                "~C:\\Users\\lalou\\OneDrive - #BicentenariaUNANLeon - Universidad Nacional Autónoma de Nicaragua "
                "León - UNAN-León\\Desktop\\Curso-Python\\wordsEn.txt")
    ...
    if os.path.isfile(user_input) is False:
        ...
        while user_output != "y" and user_output != "n":
            ...
            if user_output == "y":
                ...
                write_file = open(no_ext + "results.txt", "w")
